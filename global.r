rm(list = ls())
options(
  repos = c(CRAN = "https://mran.revolutionanalytics.com/snapshot/2022-04-07"),
...
colorPalette <- c(
  "#000000", "#56B4E9", "#009E73",
  "#F0E442", "#0072B2", "#D55E00",
  "#CC79A7", "#999999", "#E69F00"
)
colorChoices <- list(
  Boxplot = colorPalette,
...
Fonts <- c(
  "Arial", "Bahnschrift", "Cambria Math", "Comic Sans", "Courier New",
